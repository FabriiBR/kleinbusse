...
h7 = Homework.new(name:'Imagen de la derivada', content: " Calcular el número de ceros y la imagen de la función f : R  R dada por f(x)=x^6-3x^2+2", type_off: "homerkow", answer: "", lesson_id: l2.id)
h8 = Homework.new(name:'Este es un ejercicio de Derivada2', content: "Justifica que la ecuación x^2 = x sen x + cos x . Tiene exactamente dos soluciones reales", type_off: "homerkow", answer: "", lesson_id: l2.id)
h9 = Homework.new(name:'Este es un ejercicio de Derivada', content: "Prueba que las únicas funciones n veces derivables con derivada de orden n constante son las funciones polinómicas de grado", type_off: "flashcard", answer: "",  lesson_id: l2.id)
